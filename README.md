...
|------------------|----------------------------------------------------------|---------------|---------------|--------------|
| 8.4              | `phpdockerio/php:8.4-cli` <br> `phpdockerio/php:8.4-fpm` | Ubuntu 24.04  | ✔ 30 Nov 2028 | ✔            |
| 8.3              | `phpdockerio/php:8.3-cli` <br> `phpdockerio/php:8.3-fpm` | Ubuntu 22.04  | ✔ 30 Nov 2027 | ✔            |
